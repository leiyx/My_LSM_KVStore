#ifndef STORAGE_XDB_UTIL_LOGGER_H_
#define STORAGE_XDB_UTIL_LOGGER_H_
...
class LoggerImpl : public Logger {
 public:
    explicit LoggerImpl(std::FILE* fp) : fp_(fp) {}
    ~LoggerImpl() override { std::fclose(fp_); }
...
#endif // STORAGE_XDB_UTIL_LOGGER_H_